...
Prompt 1- creando tabla de prueba
create table jorge05.t04_ejemplo_extensiones(
  str char(1024)
);

Prompt 2 -consultando datos de las extensiones
set linesize window
...
Prompt 3 reservando una nueva extension
...
Pause Anilizar salida, presionar [Enter] para continuar

Prompt 4 insertando 100 registros
begin
...
Prompt 5 mostrando datos de las extensiones despues de la inserción
...
Pause Anilizar salida, presionar [Enter] para continuar
Prompt 7 Eliminando 100 registros
