...
alter system set log_archive_dest_1='LOCATION=/unam-diplomado-bd/disk-041/archivelogs/jbadip02/disk_a MANDATORY' scope=spfile;
alter system set log_archive_dest_2='LOCATION=/unam-diplomado-bd/disk-042/archivelogs/jbadip02/disk_b' scope=spfile;

--formato del archivo
alter system set log_archive_format='arch_gbldip02_%t_%s_%r.arc' scope=spfile;
