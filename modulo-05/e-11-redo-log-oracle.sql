...
--@Descripción: ejercicio 11 creacion de grupos y miembros de redo logs
...
--!find /unam-diplomado-bd/disk*/app/oracle/oradata/JBADIP02/redo* -name "*redo*.log";
--
!find /unam-diplomado-bd/disk-*/app/oracle/oradata/JBADIP02/redo*.log -name "*redo*.log" -type f -exec ls -l {} \;
-- completar 2 al 4
...
alter database add logfile group 4 (
  '/unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo04a_60.log',
  '/unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo04b_60.log'
) size 60m blocksize 512;

Prompt creando grupo 5
alter database add logfile group 5 (
  '/unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo05a_60.log',
  '/unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo05b_60.log'
) size 60m blocksize 512;

Prompt creando grupo 6
alter database add logfile group 6 (
  '/unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo06a_60.log',
  '/unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo06b_60.log'
) size 60m blocksize 512;

Prompt 6. Agregar miembros

alter database add logfile member 
  '/unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/redo04c_60.log' to group 4;

alter database add logfile member 
  '/unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/redo05c_60.log' to group 5;

alter database add logfile member 
  '/unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo06c_60.log' to group 6;
...
!rm /unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo01a.log
!rm /unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo01b.log
!rm /unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/redo01c.log

Prompt eliminando redo logs grupo 2
!rm /unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo02a.log
!rm /unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo02b.log
!rm /unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/redo02c.log

Prompt eliminando redo logs grupo 3
!rm /unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/redo03a.log
!rm /unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/redo03b.log
!rm /unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/redo03c.log
