...
--@Descripción: ejercicio backup de control file
...
! mv /unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/control01.ctl /home/oracle/backups/ ;
...
-- T2 
cd /unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02
--aqui esta control02.ctl, checar la hora y ver 
--que estan desincronizados. Ya no sirve
ls -lt 
cd /home/oracle/backups/
ls -lt
cd /unam-diplomado-bd/disk-03/app/oracle/oradata/JBADIP02/
ls -lt
...
-- T2
prompt Modificar el pfile "$ORACLE_HOME/dbs/initgbldip02.ora"
...
cd /unam-diplomado-bd/disk-02/app/oracle/oradata/JBADIP02/
ls
cp control02.ctl /unam-diplomado-bd/disk-01/app/oracle/oradata/JBADIP02/control01.ctl
...
sqlplus sys/system2 as sysdba
startup pfile=/u01/app/oracle/product/19.3.0/dbhome_1/dbs/initgbldip02.ora;
