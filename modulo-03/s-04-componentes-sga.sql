...
--@Descripción: ejercicio 4 Componentes de la SGA
...
/*
Considerar la vista v$sgainfo la cual contiene la cantidad de 
memoria asignada a cada area de memoria de la SGA
*/
prompt
Prompt Reporte 2
prompt 
