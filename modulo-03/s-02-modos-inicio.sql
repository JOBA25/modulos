...
--@Descripción: ejercicio 2 uso del modo restricted session
--y read only

prompt autenticando como sysdba
connect sys/system2 as sysdba

--Este modo permite realizar conexiones únicamente 
--a los usuarios que cuenten con el privilegio restricted session
